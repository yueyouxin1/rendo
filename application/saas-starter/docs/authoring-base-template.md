...
Use this core template when you need the official or internal `base` template for `starter templates`.
...
- keep `lineage.coreTemplate` pointing to `starter-core-template`
