...
Build the first Rendo template system around a unified `core -> base -> derived` backbone.
...
1. a stable `core` layer for every first-class template kind
...
1. `README.md`
2. `docs/00-Rendo新定位总纲.md`
3. `docs/23-Rendo模板资产分层与分类体系说明.md`
4. `docs/05-Rendo阶段化开发路线图.md`
5. `docs/10-Rendo CLI 最小协议定义.md`
6. `docs/11-Rendo Template Manifest 规范.md`
7. `docs/13-Rendo Managed、Source、Hybrid 运行模式定义.md`
8. `docs/18-rendo init 与 rendo create 的命令分工说明.md`
9. `docs/20-Rendo CLI 与 Starter、Pack、Registry 的关系说明.md`
10. `docs/24-Rendo模板分类的具体领域类型标准.md`
...
All first-class template assets follow:
...
- `rendo create`: create a concrete starter project from a base or derived starter template
...
Templates should be Rendo-ready before they are Rendo-dependent.
...
4. `rendo create` creates runnable starter projects from starter bases
