...
- [x] 明确 derived SaaS starter 的正式场景与边界
- [x] 从 application base starter 派生一个官方 SaaS starter
- [ ] 接入认证
- [x] 接入数据库与迁移
- [x] 接入 Redis
- [x] 接入制品存储
- [ ] 接入模板发布后台最小后端逻辑
- [x] 接入模板搜索、inspect、download 所需 API
- [x] 接入 capability / provider / surface 的安装宿主能力
- [x] 提供 Docker-first 启动与本地开发方案
- [x] 补齐 Agent 说明、操作说明和运维说明

## 完成标准

- [x] 该 derived starter 可以运行 Rendo headless runtime
- [x] 该 starter 可以成为 Rendo 自己的第一套狗粮宿主
