...
- [ ] 统一五类 core 模板的共享骨架生成方式，减少手工漂移
- [ ] 为每类 core 模板补齐更明确的 extension point 文档
- [ ] 明确每类 core 模板允许继承和禁止继承的边界
- [ ] 为 core 模板增加版本升级与兼容性说明
- [ ] 增加对 core 模板结构漂移的自动校验

## 完成标准

- [ ] 任何一个官方 base 模板都能明确指出自己继承自哪个 core 模板
- [ ] 任何一个官方/社区 derived 模板都能明确指出自己继承自哪个 base 模板
