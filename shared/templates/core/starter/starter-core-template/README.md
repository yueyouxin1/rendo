...
This project was initialized from the Rendo `starter-core-template`.

## What it is

- The minimal control-plane contract for `starter templates`
...
Use this template to author a `base` template for `starter templates`, then regenerate the formal artifact layer from authoring sources instead of hand-editing `shared/templates/*`.
