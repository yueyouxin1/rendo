...
- neutral kind-specific notes under `starter/`
...
Base and derived templates may add opinion, but they should not erase the minimal contract exposed by `starter-core-template`.
