...
- neutral kind-specific notes under `feature/`
...
Base and derived templates may add opinion, but they should not erase the minimal contract exposed by `feature-core-template`.
