...
This workspace is a Rendo `feature templates` core template instance.
...
- provide a stable substrate for building `feature templates` base templates without product or vendor drift
