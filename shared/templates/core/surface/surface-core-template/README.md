...
Use this template to author a `base` template for `surface templates`, then let concrete `derived` assets inherit from that base instead of bypassing the core contract.
