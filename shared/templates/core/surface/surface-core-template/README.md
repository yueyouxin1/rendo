...
This project was initialized from the Rendo `surface-core-template`.

## What it is

- The minimal control-plane contract for `surface templates`
...
Use this template to author a `base` template for `surface templates`, then regenerate the formal artifact layer from authoring sources instead of hand-editing `shared/templates/*`.
