...
Use this core template when you need the official or internal `base` template for `capability templates`.
...
- keep `lineage.coreTemplate` pointing to `capability-core-template`
