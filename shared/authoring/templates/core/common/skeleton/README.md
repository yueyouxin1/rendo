...
Use this template to author a `base` template for `__RENDO_CORE_LABEL_LOWER__`, then regenerate the formal artifact layer from authoring sources instead of hand-editing `shared/templates/*`.
