...
Use this core template when you need the official or internal `base` template for `__RENDO_CORE_LABEL_LOWER__`.
...
- keep `lineage.coreTemplate` pointing to `__RENDO_CORE_TEMPLATE_ID__`
