...
Use this core template when you need the official or internal `base` template for `provider templates`.
...
- keep `lineage.coreTemplate` pointing to `provider-core-template`
