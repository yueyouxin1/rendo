...
Use this core template when you need the official or internal `base` template for `surface templates`.
...
- keep `lineage.coreTemplate` pointing to `surface-core-template`
