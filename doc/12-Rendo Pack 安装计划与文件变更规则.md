...
**pack 不是直接“执行”，而是先声明再执行。**

---

## 2. install plan 的职责

install plan 必须回答以下问题：
...
若涉及高风险 migration，install plan 必须明确标注：
...
install plan 不只在安装时重要，在升级和移除时也应沿用同一套结构化规则。
...
**没有结构化的安装计划，pack 就无法做到真正自然、低侵入和可持续扩展。**
